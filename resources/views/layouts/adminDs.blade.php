...
<!-- HEADER SECTION BEGINS HERE CHECKIT OUT-->
<div id="header">
<!-- @include('admin.backend.header') -->
</div>
 <!--HEADER SECTION ENDS AT THIS POINT -->



<!-- ADMIN CONTENT SECTION BEGINS HERE-->
