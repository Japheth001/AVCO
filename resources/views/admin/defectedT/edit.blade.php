...
<body>
    ...
    <form action="{{url('tyres/defectedpost/'.$tyres->id)}}" method="post" class="form">
    @csrf
        <h2 class="text-center">Defect Tyre</h2><br>
        ...
        <div class="form-step form-step-active">
            ...
            <div class="btns-group" style="margin-top:20px">
                <a href="{{route('tyre.alldefected')}}" class="btn btn-prev">Back</a>
                <input type="submit" value="Defect" class="btn" />
