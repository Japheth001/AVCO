...
<body>
    ...
    <form action="{{url('tyre/update/'.$tyres->id)}}" method="post" class="form">
    @csrf
        ...
        <div class="form-step form-step-active">
            <div class="input-group">
                ...
                <input type="text" name="tyre_serial" id="tyre_serial" value="{{$tyres->tyre_serial}}"/>
            </div>
            <div class="input-group">
                <label for="lastName">Manufacturer</label>
                <input type="text" name="manufacturer" id="manufacturer" value="{{$tyres->manufacturer}}"/>
            </div>
            <div class="input-group">
                <label for="size">Size</label>
                <input type="text" name="size" id="size" value="{{$tyres->size}}"/>
            </div>
            <div class="">
        ...
        <div class="form-step">
            ...
            <div class="input-group">
                <label for="size">Front|Back</label>
                <input type="text" name="front_or_back_tyre" id="size" value="{{$tyres->front_or_back_tyre}}"/>
            </div>


             <div class="custom-selects" style="width: 200px; font-size: 12.5px;">
                                                  <select name="status" size="1" value="{{$tyres->status}}">
