                ...
                <div class ="col-md-5" style="margin: auto;">
                    <div class ="card" >
                        ...
                        <div class= "card-header">
                            ...
                            <a href="{{route('all.team')}}" class="btn btn-primary">
                    ...
                    <form action="{{url('team/update/'.$teams->id)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                            ...
                                            aria-describedby="emailHelp" value="{{$teams->name }}">
                            ...
                            <div class="form-group">
                                            ...
                                            aria-describedby="emailHelp" value="{{$teams->title}}">
                            ...
                            <div class="form-group">
                                            ...
                                            <textarea rows="2", cols="54" input type="textarea" class="form-control"  name="description"
                                            id="exampleInputEmail1" aria-describedby="emailHelp">{{$teams->description}}</textarea>
                         ...
                         <div id="ButtonCase">
                            ...
                            <div  class="btn btn-primary">
                                <button class="fa fa-paper-plane" type="submit">&nbsp<h8>Update</h8></button>
                            </div>


                            <div class="alignright">
                            <!-- <i a href="{{route('edit.back')}}" class="fa-sharp fa-solid fa-backward fa-2x" ></i> -->
                            <!-- <button type="button" style="background-color: #6666ff;" class="btn btn-primary"> <a href="{{route('all.team')}}"/>
