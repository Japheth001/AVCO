...
<body class="bg-dark">
    ...
    <div id="form" class="container bg-light">
        ...
        <form id="multiStepForm" action="{{url('battery/update/'.$batteries->id)}}" method="post" enctype="multipart/form-data">
        @csrf
            <div class="first tab">
                <div class="form-group">
                    <label for="email">Truck No:</label>
                    <input class="form-control" type="text" name="truck_id" id="truck_id" required value="{{$batteries->truck_id}}">
                </div>
                <div class="form-group">
                    <label for="password">AVCO:</label>
                    <input class="form-control" type="text" name="avco" id="avco" value="{{$batteries->avco}}">
                </div>

                <div class="form-group">
                    <label for="password">Serial No:</label>
                    <input class="form-control" type="text" name="serial_no" id="serial_no" value="{{$batteries->serial_no}}" required>
                </div>

                <div class="form-group">
                    <label for="password">Make:</label>
                    <input class="form-control" type="text" name="make" id="make" value="{{$batteries->make}}">
                </div>
            </div>
            ...
            <div class="second tab">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="size" id="size" value="{{$batteries->size}}">
                </div>
                <!-- <div class="form-group">
                ...
                <div class="form-group">
                                    <label for="exampleInputEmail1">Select Status</label>
                                            <div class="custom-selects" class="form-control" style="width: 400px; font-size: 12.5px;">
                                                    <select name="status" size="1" value="{{$batteries->status}}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="supplier" id="supplier" value="{{$batteries->supplier}}">
                </div>

                <div class="form-group">
                    <label for="surname">Date Purchased:</label>
                    <input class="form-control" type="date" name="date_purchased" id="date_purchased" value="{{$batteries->date_purchased}}">
                </div>
            </div>
            ...
            <div class="third tab">
                 <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="price" id="price" value="{{$batteries->price}}">
                </div>

                <div class="form-inline" class="form-group">
                        <div class="form-group">
                            <label for="surname">Date Install:</label>
                            <input class="form-control" type="date" name="date_install" id="date_install" value="{{$batteries->date_install}}">
                        </div>

                        <div class="form-group">
                            <label for="surname">Date Verified:</label>
                            <input class="form-control" type="date" name="verified_date" id="verified_date" value="{{$batteries->verified_date}}">
                        </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="movement" id="movement" value="{{$batteries->movement}}">
                </div>

                <div class="form-group">
                    <label for="surname">Comments:</label>

                    <textarea class="form-control"  id="comments" name="comments" rows="3" cols="50" 
                    maxlength="200" placeholder="If any...">{{$batteries->comments}}
