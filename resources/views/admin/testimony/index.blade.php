...
<div>
                    <button type="button" style="background-color: #6666ff; margin-left: 1200px; margin-top:10px; margin-bottom:-40px" class="btn btn-primary"> <a href="{{route('new.testimonial')}}"/>
...
<!--
                        ...
                        <!-- <div style="margin-left: 25px;">All testimonial</div> -->
        ...
        <th scope="row">{{$testimonials->firstitem()+$loop->index}}</th>
                    ...
                    <td>{{$testimonial->customer}}</td>
                    <td>{{$testimonial->comments}}</td>
                  <td>{{$testimonial->created_at}}</td>
                    <td><a href="{{url('/testimonial/edit/'.$testimonial->id)}}"<span style="width:70px" class="btn btn-info">Edit</span></td>
                    <td><a href="{{url('testimonial/delete/'. $testimonial->id)}}"<span class="btn btn-danger">Delete</span></td>
        </tr>
        @endforeach
                                </tbody>
                        </table>
