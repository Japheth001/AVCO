...
<section id="testimonials">
        <div class="container">
          <h1 style="margin-top:-35px;">Front- End Website Management</h1>
          ...
          <div class="row">
              <div class="col-md-3 text-center">
                  ...
                  <div id="cbtn1">
                  <i style="font-size:35px" <i style="color:black" class="fa-sharp fa-tire blackiconcolor"><a style="text-decoration: none; background-color: transparent;" href="" </a> <span style="font-size:40px" ></span></b></i></a>
                    </div>
                      <!-- <img src="images/me2.jpg" class="user"> -->
                      
                      <!-- <blockquote>I</blockquote> -->
                      <h3><span><a href="{{route('all.slider')}}"> SLIDER</a></span></h3>
                  </div>
              </div>
